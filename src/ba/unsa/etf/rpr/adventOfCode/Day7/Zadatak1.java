//import re
//
//main_raw_input = """bright indigo bags contain 4 shiny turquoise bags, 3 wavy yellow bags.
...
//
//        contents_string = bag_and_contents[2]  # [:-1] removes trailing period
...
//        count = 0
//        bag = bag_collection[bag_name] #uzima kolekciju za bag name
//        print(bag_name)
//
//        if len(bag) == 0:
//        return count
...
//
//
//        collection = create_data_structure(main_raw_input)
//        print(bags_containing_at_least_one_shiny_gold_bag(collection))