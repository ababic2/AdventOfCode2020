package ba.unsa.etf.rpr.adventOfCode.Day6;
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < strArray.length; i++) {
            ...
            if(!strArray[i].trim().isEmpty()) { ///nije blank string
                String[] osobe = strArray[i].split("\n");
                broj_osoba += 1;
                System.out.println("BROJ OSOBA " + broj_osoba);
                for(int j = 0; j < osobe.length; j++) {
                    System.out.println("OSOBA " + broj_osoba);
                    System.out.println(osobe[j]);
                    for(int k = 0; k < osobe[j].length(); k++) {
                        if (mapa.containsKey(String.valueOf(osobe[j].charAt(k)))) {
                            int value = mapa.get(String.valueOf(osobe[j].charAt(k)));
                            mapa.put(String.valueOf(osobe[j].charAt(k)), value + 1);
                        }
                        else mapa.put(String.valueOf(osobe[j].charAt(k)), 1);
                    }
                }
...
//                ispisMape(mapa);
            ...
            if(strArray[i].trim().isEmpty() || i == strArray.length - 1){
                System.out.println("CHECK ");// + checkIfMapContainsValue(mapa, broj_osoba));
                List<String> lista = checkIfMapContainsValue(mapa, broj_osoba);
...
//                System.out.println(counter);
    ...
    public static List<String> getKey(Map<String, Integer> map, int value)
    {
    ...
    private static List<String> checkIfMapContainsValue(Map<String, Integer> mapa, int length) {
        return getKey(mapa,length);
    }

    private static void ispisMape(Map<String, Integer> mapa) {
        mapa.entrySet()
